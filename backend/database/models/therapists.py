...
class Therapist(Base):
    ...
    psychiatrist: Mapped[bool] = mapped_column(server_default='false')
    group_therapy:  Mapped[bool] = mapped_column(server_default='false')
    supervisor:  Mapped[bool] = mapped_column(server_default='false')
    gerontologist: Mapped[bool] = mapped_column(server_default='false')
    couple_therapist: Mapped[bool] = mapped_column(server_default='false')
